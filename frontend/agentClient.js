 ...
 * @param {{appName:string,userId:string,sessionId:string,message:string}} params
 ...
 */
export async function sendTextMessage({ appName, userId, sessionId, message }, onEventData) {
